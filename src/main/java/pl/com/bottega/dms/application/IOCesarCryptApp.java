...
//        int data;
//        try {
//            InputStream inputStreamToCrypt = new CesarInputStream(new FileInputStream(fileInputPath));
...
//            OutputStream outputStreamDecrypt = new CesarOutputStream(new FileOutputStream(FileOutputDecryptPath));
